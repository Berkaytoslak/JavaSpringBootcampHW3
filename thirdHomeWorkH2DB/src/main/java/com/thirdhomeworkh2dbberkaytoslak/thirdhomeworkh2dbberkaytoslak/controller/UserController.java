package com.thirdhomeworkh2dbberkaytoslak.thirdhomeworkh2dbberkaytoslak.controller;
...
public class UserController {
    ...
    public String showUpdatePage(@PathVariable int id, Model theModel){
        User user = repository.findById(id).orElseThrow(()->new IllegalArgumentException("User id: " + id));
